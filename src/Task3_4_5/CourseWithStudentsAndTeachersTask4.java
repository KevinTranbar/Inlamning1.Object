...
public class CourseWithStudentsAndTeachersTask4 {
    ...
    CourseTask3 course2; //Initiate Task3_4.CourseTask3 class in this class to use Task3_4.CourseTask3 attributes and such (**CAN'T ASSIGN SOMETHING THAT HASN'T BEEN DECLARED***)

    public CourseWithStudentsAndTeachersTask4(String cCode, String cName, int maxNumOfStudents, int maxNumOfTeachers) { //Create course object with Task3_4.CourseTask3 class attributes
